  ...
  return (
    <div className="app-container">
      ...
      <div className="top-bar">
        ...
        <button className="btn" onClick={handleAddLink}>Adicionar Link</button>
      </div>
        ...
        <table>
          <thead>
            <tr>
              ...
              <th onClick={() => handleToggleFilter('wifi')} style={{ cursor: 'pointer', userSelect: 'none' }}>Wi-Fi {filters.wifi ? '🔍' : ''}</th>
              <th onClick={() => handleToggleFilter('tv')} style={{ cursor: 'pointer', userSelect: 'none' }}>TV {filters.tv ? '🔍' : ''}</th>
              <th onClick={() => handleToggleFilter('air_conditioning')} style={{ cursor: 'pointer', userSelect: 'none' }}>Ar Cond.</th>
              <th onClick={() => handleToggleFilter('kitchen')} style={{ cursor: 'pointer', userSelect: 'none' }}>Cozinha</th>
              <th onClick={() => handleToggleFilter('petfriendly')} style={{ cursor: 'pointer', userSelect: 'none' }}>Pet</th>
              <th>Endereço</th>
            ...
            {displayedItems.map((acc) => (
              <tr key={acc.id}>
                ...
                <td style={{ textAlign: 'center' }}>
                  <button onClick={() => handleDeleteLink(acc.id)} className="btn-ghost" title="Excluir link">🗑️</button>
                </td>
              </tr>
            ))}
